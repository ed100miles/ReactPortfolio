    ...
    return (
        <div className='about-div'>
            ...
            <div className='about-blurb-div'>
                ...
                <p>Now I've decided to try and turn my passion into a career - if you think I could be a good fit with your team, send me an email and we can chat.</p>
                ...
                <p>You can see some examples of things I've built in the 'projects' section below. You'll also find links to my github account where you can check out the source code.</p>
